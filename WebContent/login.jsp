...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>${messages.getString('nav_bar_login') }</div>
            ...
            <p class="details">
             Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.
                ...
                <div class="form_subtitle">${messages.getString('from_account') }</div>
                 <form name="register" action="./CheckLogin" method="post">          
                    ...
                    <div class="form_row">
                        ...
                        ${messages.getString('form_checkbox_account') }
                        </div>
                    </div>
                    <p style="color:red">
                    ${errorMessage}
                    ...
                    <div class="form_row">
                    <input type="submit" class="register" value="${messages.getString('nav_bar_login') }" />
                    </div>   
