...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin User - Delete User</title>
    </head>
    ...
    <body>
        ...
        <div class="admin-wrapper">
            ...
            <form action="../../UserDelete?id=<%=U.getId()%>" method="post">
            			<div>
                            <label>ID</label>
                        ...
                        <div>
                            ...
                            <input type="text" name="username" value="<%=U.getUsername()%>" disabled="disabled" class="text-input"/>
                        </div>
                        <div>
                            <label>Password</label>
                            <input type="text" name="password" value="<%=U.getPassword()%>" disabled="disabled" class="text-input"/>
                        </div>
                        <div>
                            <label>Email</label>
                            <input type="text" name="email" value="<%=U.getEmail()%>" disabled="disabled" class="text-input"/>
                        </div>
                        <div>
                            <label>Phone</label>
                            <input type="text" name="phone" value="<%=U.getPhone()%>" disabled="disabled" class="text-input"/>
                        </div>
                        <div>
                            <label>Company</label>
                            <input type="text" name="company" value="<%=U.getCompany()%>" disabled="disabled" class="text-input"/>
                        </div>
                        <div>
                            <label>Address</label>
                            <input type="text" name="address" value="<%=U.getAddress()%>" disabled="disabled" class="text-input"/>
                        </div>
                        
                        <div>
                            <label>isAdmin</label>
                            <input type="text" name="address" value="<%=U.isAdmin()%>" disabled="disabled" class="text-input"/>
