...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin Category - Delete Category</title>
    </head>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                ...
                <div class="content">
                    ...
                    <h2 class="page-title">Delete Category</h2>
	<form action="../../CategoryDelete?id=<%=C.getId()%>" method="post"> 
                        ...
                        <div>
                            <label>Name</label>
                                <input type="text" name="name" class="text-input" value="<%=C.getName()%>" disabled="disabled"/>
                        </div>        
                        <div>
